...
> Current preview builds are unsigned. Windows SmartScreen and macOS Gatekeeper may warn until production signing is configured.
...
License is not finalized yet. Treat the project as source-available until a license file is added.
...
RigScope уже собирается под Windows, Linux и macOS. Следующие важные шаги:
...
Лицензия пока не выбрана. До появления `LICENSE` считай проект source-available.
